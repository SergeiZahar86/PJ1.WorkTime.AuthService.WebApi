...
namespace PJ1.AuthService.WebApi.Account
{
    [SecurityHeaders]
    [AllowAnonymous]
    public class ExternalController : Controller
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            await _events.RaiseAsync(new UserLoginSuccessEvent(provider, providerUserId,
                user.Id.ToString(), name, true, context?.Client.ClientId));
        ...
        private async Task<(AppUser user, string provider, string providerUserId, IEnumerable<Claim>
                claims)>
